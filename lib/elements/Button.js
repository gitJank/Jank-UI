...
const Button = styled.button`
  ...
  &:active {
    -webkit-box-shadow: inset 0px 0px 25px ${({ bgColor }) => lighten(0.4, colors[bgColor])};
       -moz-box-shadow: inset 0px 0px 25px ${({ bgColor }) => lighten(0.4, colors[bgColor])};
            box-shadow: inset 0px 0px 25px ${({ bgColor }) => lighten(0.4, colors[bgColor])};
  }
`;
